...
{
    public class ConfigureInternalCookieOptionsEx: IConfigureNamedOptions<CookieAuthenticationOptions>
    {
        private readonly IdentityServerOptions _idsrv;

        public ConfigureInternalCookieOptionsEx(IdentityServerOptions idsrv)
        {
            _idsrv = idsrv;
        }
